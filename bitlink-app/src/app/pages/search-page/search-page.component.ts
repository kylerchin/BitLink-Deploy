...
export class SearchPageComponent {
  ...
  message: string = 'Python\'s new features are game-changers! From pattern matching to improved error handling, this language keeps getting better. 🐍🚀 #Python #Coding #Tech';
  ...
  message2: string = "This language is the worst! Indentation errors and slow execution speed make me want to scream. Here’s why you should never use python ever!!! 🙄 #PythonSucks #CodingFrustrations";
